...
/* 	for (var i = 0; i < loc.length; i ++) {
	...
	function check2(){
		var deviceIds = [564785374,564844586];
		var deviceId;
		for(var i = 0;i<devices.length;i++) {
	...
	// var api = new OneNetApi('i4f61Ym1937Tei6G8W4cZAzcU5s=');
	// api.getDataStreams(564785374).done(function(data){
	// 	console.log('api调用完成，服务器返回data为：', data);
	// });
	// api.getDataStreams(564844586).done(function(data){
	// 	console.log('api调用完成，服务器返回data为：', data);
	// });


	// var api = new OneNetApi('i4f61Ym1937Tei6G8W4cZAzcU5s=');
	// api.getDataPoints(564785374, {datastream_id:'location'}).done(function(data){
	// 	console.log('api调用完成，服务器返回data为：', data.data.datastreams[0].datapoints[0]);
	// });
